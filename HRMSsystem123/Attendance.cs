...
namespace HRMSsystem123
{
    public partial class Attendance : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("EmpAttendance", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@status", "INSERT");
            cmd.Parameters.AddWithValue("@EmpID", txtempid.Text);
            cmd.Parameters.AddWithValue("@NoOfPresent", txtnopresence.Text);
            cmd.Parameters.AddWithValue("@NoOfAbsence", txtnoabsence.Text);
            cmd.Parameters.AddWithValue("@Details", txtcontactno.Text);
        ...
        private void txtnopresence_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar) == false)
            {
        ...
        private void txtnoabsence_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtnoabsence_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar) == false)
            {
                MessageBox.Show("Please Enter Valid No. ");
        ...
        private void txtcontactno_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar) == false)
            {
                MessageBox.Show("Please Enter Vaild Contact No. ");
